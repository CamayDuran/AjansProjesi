...
namespace NesneAjansProjesi
{
    public partial class Form2 : Form
    {
        ...
        {
            SqlDataAdapter musteri_da = new SqlDataAdapter("Select * from tblMusteri", baglanti);
        ...
        private void btn_guncelle_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand guncelle = new SqlCommand("Update tblMusteri set maas=@yenimaas where calisanID=@id ", baglanti);
            guncelle.Parameters.AddWithValue("@yenimaas", textBox_yenimaas.Text);
            guncelle.Parameters.AddWithValue("@id", textBox_id.Text);
            guncelle.ExecuteNonQuery();

            SqlDataAdapter goster = new SqlDataAdapter("Select * from tblMusteri ", baglanti);
            DataSet ds = new DataSet();
            goster.Fill(ds);
        ...
        private void btn_izinGunuGuncelle_Click(object sender, EventArgs e)
        {
            baglanti.Open();
